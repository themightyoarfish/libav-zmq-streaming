...
#
#  LIBAV_FOUND             - system has libavcodec, libavformat, libavutil, libswscale
#  LIBAV_INCLUDE_DIRS      - libav include directories
...
if(PKG_CONFIG_FOUND)
    ...
    if(NOT LIBSWSCALE_LIBRARY)
        pkg_check_modules(_LIBAV_SWSCALE libavutil)
    endif()
...
set(LIBAV_INCLUDE_DIRS ${LIBAVCODEC_INCLUDE_DIR}
                      #TODO: add other include paths
                      )
